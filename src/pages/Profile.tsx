...
import {
  ...
  Heart, Search, MessageCircle, Inbox
} from "lucide-react";
        ...
        >
          ...
          <div className="px-6 sm:px-10 pb-6 -mt-14 sm:-mt-16 relative">
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-5">
              <motion.div whileHover={{ scale: 1.05 }} className="relative group cursor-pointer" onClick={() => avatarInputRef.current?.click()}>
              ...
              <div className="flex-1 text-center sm:text-left sm:pb-1">
                <h1 className="text-2xl sm:text-3xl font-bold text-foreground">{profile.display_name || "Sin nombre"}</h1>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Button
                  variant={isEditing ? "ghost" : "outline"} size="sm"
